...
_ENABLE_KVCS_STORE = os.getenv("ENABLE_KVCS_STORE", "0") == "1"
...
class ConfigParser:
    ...
    def get_unified_config(
        ...
        config_cls = KVCSStoreConfig if _ENABLE_KVCS_STORE else PipelineStoreConfig
        store_config = config_cls(**store_data)

        if _ENABLE_KVCS_STORE and store_config.kvcs_tls_enable:
