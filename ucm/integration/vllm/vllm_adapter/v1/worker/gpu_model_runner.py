...
import vllm.v1.worker.gpu_model_runner as vllm_v1_gpu_model_runner

from ucm.integration.vllm.vllm_adapter.v1.outputs import ModelRunnerOutput


class GPUModelRunner(vllm_v1_gpu_model_runner.GPUModelRunner):
            ...
            for req_id in self.input_batch.req_id_to_index:
                ...
                if is_sparsed_request:
                    sparsed_positions[req_index] -= (
                        self.seq_lens_cpu[:num_reqs][req_index]
                        - req_sparsed_slots[req_id]
                    )
...
vllm_v1_gpu_model_runner.GPUModelRunner = GPUModelRunner
