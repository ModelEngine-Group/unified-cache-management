...
class GSAConfig:
    ...
    def set_config(self, block_szie):
        ...
        self.num_prefetch_blocks = math.ceil(NUM_PREFETCH_BLOCKS * DEFAULT_BLOCK_SIZE / block_szie)
        self.init_windows_size = math.ceil(INIT_WINDOW_SZ * DEFAULT_BLOCK_SIZE / block_szie)
        self.num_gsa_blocks = math.ceil(NUM_GSA_BLOCKS * DEFAULT_BLOCK_SIZE / block_szie)
