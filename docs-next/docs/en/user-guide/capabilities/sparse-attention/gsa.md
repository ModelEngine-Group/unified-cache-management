...
[![Paper](https://img.shields.io/badge/Paper-ACL%202025-blue)](/assets/paper/kvcomp-ACL-2025-paper.pdf)
...
- **Adaptive Sparsity**: Layer-wise sparsity ratios that adapt to model characteristics
