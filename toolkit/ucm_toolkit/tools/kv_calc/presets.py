...
_PRESET_MODELS = [
    ...
    # ------------------------------------------------------------------
    dict(id="deepseek-ai/DeepSeek-V3", architectures=["DeepseekV3ForCausalLM"],
         attention_class="mla",
         ...
         v_head_dim=128),
    dict(id="deepseek-ai/DeepSeek-R1", architectures=["DeepseekV3ForCausalLM"],
         attention_class="mla",
         hidden_size=7168, num_attention_heads=128, num_hidden_layers=61,
         num_key_value_heads=128, kv_lora_rank=512, qk_rope_head_dim=64,
         v_head_dim=128),
    dict(id="deepseek-ai/DeepSeek-V3.1-Terminus", architectures=["DeepseekV3ForCausalLM"],
         attention_class="mla",
         hidden_size=7168, num_attention_heads=128, num_hidden_layers=61,
         num_key_value_heads=128, kv_lora_rank=512, qk_rope_head_dim=64,
         v_head_dim=128),
    ...
    # ------------------------------------------------------------------
    dict(id="deepseek-ai/DeepSeek-V3.2", architectures=["DeepseekV32ForCausalLM"],
         attention_class="dsa",
         hidden_size=7168, num_attention_heads=128, num_hidden_layers=61,
         num_key_value_heads=128, kv_lora_rank=512, qk_rope_head_dim=64,
         index_head_dim=128, index_n_heads=64, index_topk=2048, v_head_dim=128),
    # ------------------------------------------------------------------
    # DeepSeek V4 — compressed sparse attention + measured deployments
    # arch: DeepseekV4ForCausalLM (verified); compress_ratios verified
    # ------------------------------------------------------------------
    dict(id="deepseek-ai/DeepSeek-V4-Pro", architectures=["DeepseekV4ForCausalLM"],
         attention_class="deepseek_v4",
         hidden_size=7168, num_attention_heads=128, num_hidden_layers=61,
         num_key_value_heads=1, head_dim=512, index_head_dim=128,
         index_n_heads=64, index_topk=1024, qk_rope_head_dim=64, sliding_window=128,
         compress_ratios=_v4_compress_ratios_pro(),
         deployment_measured=V4_MEASURED["deepseek-ai/DeepSeek-V4-Pro"]),
    dict(id="deepseek-ai/DeepSeek-V4-Flash", architectures=["DeepseekV4ForCausalLM"],
         attention_class="deepseek_v4",
         hidden_size=4096, num_attention_heads=64, num_hidden_layers=43,
         num_key_value_heads=1, head_dim=512, index_head_dim=128,
         index_n_heads=64, index_topk=512, qk_rope_head_dim=64, sliding_window=128,
    ...
    # ------------------------------------------------------------------
    dict(id="zai-org/GLM-4.7-Flash", architectures=["Glm4MoeLiteForCausalLM"],
         attention_class="mla",
         hidden_size=2048, num_attention_heads=20, num_hidden_layers=47,
         num_key_value_heads=20, kv_lora_rank=512, qk_rope_head_dim=64,
         v_head_dim=256),
    # ------------------------------------------------------------------
    # DSA — GLM-5 / 5.1 (arch: GlmMoeDsaForCausalLM, verified)
    # ------------------------------------------------------------------
    dict(id="zai-org/GLM-5", architectures=["GlmMoeDsaForCausalLM"],
         attention_class="dsa",
         hidden_size=6144, num_attention_heads=64, num_hidden_layers=78,
         num_key_value_heads=64, head_dim=64, kv_lora_rank=512, qk_rope_head_dim=64,
         index_head_dim=128, index_n_heads=32, index_topk=2048, v_head_dim=256),
    dict(id="zai-org/GLM-5.1", architectures=["GlmMoeDsaForCausalLM"],
         attention_class="dsa",
         hidden_size=6144, num_attention_heads=64, num_hidden_layers=78,
         num_key_value_heads=64, head_dim=64, kv_lora_rank=512, qk_rope_head_dim=64,
         index_head_dim=128, index_n_heads=32, index_topk=2048, v_head_dim=256),
    ...
    # ------------------------------------------------------------------
    dict(id="moonshotai/Kimi-K2", architectures=["DeepseekV3ForCausalLM"],
         attention_class="mla",
         hidden_size=7168, num_attention_heads=64, num_hidden_layers=61,
         num_key_value_heads=64, kv_lora_rank=512, qk_rope_head_dim=64,
         v_head_dim=128),
    dict(id="moonshotai/Kimi-K2.5", architectures=["DeepseekV3ForCausalLM"],
         attention_class="mla",
         hidden_size=7168, num_attention_heads=64, num_hidden_layers=61,
         num_key_value_heads=64, kv_lora_rank=512, qk_rope_head_dim=64,
         v_head_dim=128),
    dict(id="moonshotai/Kimi-K2.6", architectures=["DeepseekV3ForCausalLM"],
         attention_class="mla",
         hidden_size=7168, num_attention_heads=64, num_hidden_layers=61,
         num_key_value_heads=64, kv_lora_rank=512, qk_rope_head_dim=64,
         v_head_dim=128),
    ...
    # ------------------------------------------------------------------
    dict(id="Qwen/Qwen3-32B", architectures=["Qwen3ForCausalLM"],
         attention_class="standard",
         hidden_size=5120, num_attention_heads=64, num_hidden_layers=64,
         num_key_value_heads=8, head_dim=128),
    # ------------------------------------------------------------------
    # Standard (GQA) — Qwen3 MoE (arch: Qwen3MoeForCausalLM, verified;
    # MoE does not change the per-token KV cache)
    # ------------------------------------------------------------------
    dict(id="Qwen/Qwen3-235B-A22B", architectures=["Qwen3MoeForCausalLM"],
         attention_class="standard",
         hidden_size=4096, num_attention_heads=64, num_hidden_layers=94,
         num_key_value_heads=4, head_dim=128),
    dict(id="Qwen/Qwen3-Coder-480B-A35B-Instruct", architectures=["Qwen3MoeForCausalLM"],
         attention_class="standard",
         hidden_size=6144, num_attention_heads=96, num_hidden_layers=62,
         num_key_value_heads=8, head_dim=128),
    # ------------------------------------------------------------------
    # Standard (GQA) — Llama 3.1 (arch: LlamaForCausalLM, canonical HF class;
    # repo gated, not freshly re-fetched)
    # ------------------------------------------------------------------
    dict(id="meta-llama/Llama-3.1-70B-Instruct", architectures=["LlamaForCausalLM"],
         attention_class="standard",
         hidden_size=8192, num_attention_heads=64, num_hidden_layers=80,
         num_key_value_heads=8),
    dict(id="meta-llama/Llama-3.1-405B", architectures=["LlamaForCausalLM"],
         attention_class="standard",
         hidden_size=16384, num_attention_heads=128, num_hidden_layers=126,
         num_key_value_heads=8),
    # ------------------------------------------------------------------
    # Standard (GQA) — GLM-4.5 family (arch: Glm4MoeForCausalLM, verified)
    # ------------------------------------------------------------------
    dict(id="zai-org/GLM-4.5", architectures=["Glm4MoeForCausalLM"],
         attention_class="standard",
         hidden_size=5120, num_attention_heads=96, num_hidden_layers=92,
         num_key_value_heads=8, head_dim=128),
    dict(id="zai-org/GLM-4.5-Air", architectures=["Glm4MoeForCausalLM"],
         attention_class="standard",
         hidden_size=4096, num_attention_heads=96, num_hidden_layers=46,
         num_key_value_heads=8, head_dim=128),
    dict(id="zai-org/GLM-4.7", architectures=["Glm4MoeForCausalLM"],
         attention_class="standard",
         hidden_size=5120, num_attention_heads=96, num_hidden_layers=92,
         num_key_value_heads=8, head_dim=128),
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    dict(id="MiniMaxAI/MiniMax-M2", architectures=["MiniMaxM2ForCausalLM"],
         attention_class="standard",
         hidden_size=3072, num_attention_heads=48, num_hidden_layers=62,
         num_key_value_heads=8, head_dim=128),
    dict(id="MiniMaxAI/MiniMax-M2.1", architectures=["MiniMaxM2ForCausalLM"],
         attention_class="standard",
         hidden_size=3072, num_attention_heads=48, num_hidden_layers=62,
         num_key_value_heads=8, head_dim=128),
    dict(id="MiniMaxAI/MiniMax-M2.5", architectures=["MiniMaxM2ForCausalLM"],
         attention_class="standard",
         hidden_size=3072, num_attention_heads=48, num_hidden_layers=62,
         num_key_value_heads=8, head_dim=128),
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    dict(id="google/gemma-4-31b-it", architectures=["Gemma4ForConditionalGeneration"],
         attention_class="mixed_full_sliding",
         hidden_size=5376, num_attention_heads=32, num_hidden_layers=60,
         num_key_value_heads=16, head_dim=256,
         global_head_dim=512, num_global_key_value_heads=4,
         sliding_window=1024, num_kv_shared_layers=0,
         layer_types=_gemma4_layer_types()),
    # ------------------------------------------------------------------
    # Mixed full/sliding — MiMo V2.5 (arch: MiMoV2ForCausalLM; org XiaomiMiMo,
    # verified)
    # ------------------------------------------------------------------
    dict(id="XiaomiMiMo/MiMo-V2.5", architectures=["MiMoV2ForCausalLM"],
         attention_class="mixed_full_sliding",
         hidden_size=4096, num_attention_heads=64, num_hidden_layers=48,
         ...
         sliding_window=128, hybrid_layer_pattern=_mimo_v2_5_pattern()),
    # ------------------------------------------------------------------
    # Qwen linear/full hybrid — Qwen3.6-27B (arch: Qwen3_5ForConditionalGeneration,
    # verified at Qwen/Qwen3.6-27B)
    # ------------------------------------------------------------------
    dict(id="Qwen/Qwen3.6-27B", architectures=["Qwen3_5ForConditionalGeneration"],
         attention_class="qwen_linear_full",
         hidden_size=5120, num_attention_heads=24, num_hidden_layers=64,
         num_key_value_heads=4, head_dim=256,
         linear_num_key_heads=16, linear_key_head_dim=128,
         linear_num_value_heads=48, linear_value_head_dim=128,
         linear_conv_kernel_dim=4, layer_types=_qwen36_layer_types()),
    ...
    dict(id="Qwen/Qwen3.5-27B", architectures=["Qwen3_5ForConditionalGeneration"],
         attention_class="qwen_linear_full",
         hidden_size=5120, num_attention_heads=24, num_hidden_layers=64,
         num_key_value_heads=4, head_dim=256,
         linear_num_key_heads=16, linear_key_head_dim=128,
    ...
    dict(id="Qwen/Qwen3.5-9B", architectures=["Qwen3_5ForConditionalGeneration"],
         attention_class="qwen_linear_full",
         hidden_size=4096, num_attention_heads=16, num_hidden_layers=32,
         num_key_value_heads=4, head_dim=256,
         linear_num_key_heads=16, linear_key_head_dim=128,
         linear_num_value_heads=32, linear_value_head_dim=128,
         linear_conv_kernel_dim=4),
    dict(id="Qwen/Qwen3.5-4B", architectures=["Qwen3_5ForConditionalGeneration"],
         attention_class="qwen_linear_full",
         hidden_size=2560, num_attention_heads=16, num_hidden_layers=32,
         num_key_value_heads=4, head_dim=256,
         linear_num_key_heads=16, linear_key_head_dim=128,
         linear_num_value_heads=32, linear_value_head_dim=128,
         linear_conv_kernel_dim=4),
    dict(id="Qwen/Qwen3.5-2B", architectures=["Qwen3_5ForConditionalGeneration"],
         attention_class="qwen_linear_full",
         hidden_size=2048, num_attention_heads=8, num_hidden_layers=24,
         num_key_value_heads=2, head_dim=256,
         linear_num_key_heads=16, linear_key_head_dim=128,
         linear_num_value_heads=16, linear_value_head_dim=128,
         linear_conv_kernel_dim=4),
    dict(id="Qwen/Qwen3.5-0.8B", architectures=["Qwen3_5ForConditionalGeneration"],
         attention_class="qwen_linear_full",
         hidden_size=1024, num_attention_heads=8, num_hidden_layers=24,
         num_key_value_heads=2, head_dim=256,
         linear_num_key_heads=16, linear_key_head_dim=128,
         linear_num_value_heads=16, linear_value_head_dim=128,
         linear_conv_kernel_dim=4),
    dict(id="Qwen/Qwen3.5-122B-A10B", architectures=["Qwen3_5MoeForConditionalGeneration"],
         attention_class="qwen_linear_full",
         hidden_size=3072, num_attention_heads=32, num_hidden_layers=48,
         num_key_value_heads=2, head_dim=256,
         linear_num_key_heads=16, linear_key_head_dim=128,
         linear_num_value_heads=64, linear_value_head_dim=128,
         linear_conv_kernel_dim=4),
    dict(id="Qwen/Qwen3.5-397B-A17B", architectures=["Qwen3_5MoeForConditionalGeneration"],
         attention_class="qwen_linear_full",
         hidden_size=4096, num_attention_heads=32, num_hidden_layers=60,
         num_key_value_heads=2, head_dim=256,
         linear_num_key_heads=16, linear_key_head_dim=128,
         linear_num_value_heads=64, linear_value_head_dim=128,
         linear_conv_kernel_dim=4),
    dict(id="Qwen/Qwen3.5-35B-A3B", architectures=["Qwen3_5MoeForConditionalGeneration"],
         attention_class="qwen_linear_full",
         hidden_size=2048, num_attention_heads=16, num_hidden_layers=40,
         num_key_value_heads=2, head_dim=256,
         linear_num_key_heads=16, linear_key_head_dim=128,
         linear_num_value_heads=32, linear_value_head_dim=128,
         linear_conv_kernel_dim=4),
    dict(id="Qwen/Qwen3.6-35B-A3B", architectures=["Qwen3_5MoeForConditionalGeneration"],
         attention_class="qwen_linear_full",
         hidden_size=2048, num_attention_heads=16, num_hidden_layers=40,
         num_key_value_heads=2, head_dim=256,
         linear_num_key_heads=16, linear_key_head_dim=128,
         linear_num_value_heads=32, linear_value_head_dim=128,
         linear_conv_kernel_dim=4),
    dict(id="Qwen/Qwen3.8-27B", architectures=["Qwen3_5ForConditionalGeneration"],
         attention_class="qwen_linear_full",
         hidden_size=5120, num_attention_heads=24, num_hidden_layers=64,
         num_key_value_heads=4, head_dim=256,
         linear_num_key_heads=16, linear_key_head_dim=128,
         linear_num_value_heads=48, linear_value_head_dim=128,
         linear_conv_kernel_dim=4),
    dict(id="Qwen/Qwen3.8-2.4T-A95B", architectures=["Qwen3_5MoeForCausalLM"],
         attention_class="qwen_linear_full",
         hidden_size=8192, num_attention_heads=64, num_hidden_layers=92,
         num_key_value_heads=4, head_dim=256,
         linear_num_key_heads=16, linear_key_head_dim=128,
    ...
    dict(id="moonshotai/Kimi-K3", architectures=["KimiK3ForConditionalGeneration"],
         attention_class="mla",
         hidden_size=7168, num_attention_heads=96, num_hidden_layers=93,
         num_key_value_heads=96, kv_lora_rank=512, qk_rope_head_dim=64,
         v_head_dim=128,
    ...
    dict(id="moonshotai/Kimi-K2.7-Code", architectures=["KimiK25ForConditionalGeneration"],
         attention_class="mla",
         hidden_size=7168, num_attention_heads=64, num_hidden_layers=61,
         num_key_value_heads=64, kv_lora_rank=512, qk_rope_head_dim=64,
         v_head_dim=128),
    ...
    dict(id="dots-studio/dots3-note-prev", architectures=["Dots3NoteForCausalLM"],
         attention_class="dsa",
         hidden_size=5120, num_attention_heads=128, num_hidden_layers=46,
         num_key_value_heads=128, kv_lora_rank=512, qk_rope_head_dim=64,
         index_head_dim=128, index_n_heads=64, index_topk=2048, v_head_dim=128,
         swa_v_head_dim=128, swa_num_key_value_heads=64,
         note="Config carries swa_* fields but no full/sliding layer split; "
              ...
              "pure sliding-window)."),
    dict(id="openpangu/openPangu-2.0-Pro", architectures=["OpenPanguV2ForCausalLM"],
         attention_class="dsa",
         hidden_size=5120, num_attention_heads=64, num_hidden_layers=50,
         kv_lora_rank=512, qk_rope_head_dim=64, index_head_dim=128,
         index_n_heads=32, index_topk=2048, sliding_window=512, v_head_dim=128),
    dict(id="openpangu/openPangu-2.0-Flash", architectures=["OpenPanguV2ForCausalLM"],
         attention_class="dsa",
         hidden_size=2560, num_attention_heads=48, num_hidden_layers=46,
         kv_lora_rank=512, qk_rope_head_dim=64, index_head_dim=128,
         index_n_heads=24, index_topk=2048, sliding_window=512, v_head_dim=128),
    dict(id="meituan-longcat/LongCat-2.0", architectures=["LongcatCausalLM"],
         attention_class="dsa",
         num_layers=38, hidden_size=8192, num_attention_heads=64,
         kv_lora_rank=512, qk_rope_head_dim=64, index_head_dim=128,
         index_n_heads=32, index_topk=2048, v_head_dim=128,
         note="Config uses 'num_layers' (not num_hidden_layers); both are "
              "read. attention_method=MLA + Lightning Indexer -> DSA."),
    dict(id="zai-org/GLM-5.2", architectures=["GlmMoeDsaForCausalLM"],
         attention_class="dsa",
         hidden_size=6144, num_attention_heads=64, num_hidden_layers=78,
         num_key_value_heads=64, head_dim=192, kv_lora_rank=512,
         qk_rope_head_dim=64, index_head_dim=128, index_n_heads=32,
         index_topk=2048, v_head_dim=256,
    ...
    dict(id="inclusionAI/Ling-3.0-tiny", architectures=["BailingMoeV3ForCausalLM"],
         attention_class="mla",
         hidden_size=1536, num_attention_heads=16, num_hidden_layers=24,
         num_key_value_heads=16, head_dim=128, kv_lora_rank=512,
    ...
    dict(id="inclusionAI/Ling-3.0-flash", architectures=["BailingMoeV3ForCausalLM"],
         attention_class="mla",
         hidden_size=2560, num_attention_heads=32, num_hidden_layers=42,
    ...
    dict(id="meta-models/Muse-Glimmer-30B", architectures=["MuseGlimmerForConditionalGeneration"],
         attention_class="standard",
         hidden_size=6656, num_attention_heads=32, num_hidden_layers=52,
         ...
         note="Pure sliding-window attention (sliding_window=2048, no full/"
              ...
              "(vLLM SWA behavior)."),
    dict(id="mistralai/Mistral-Large-Instruct-2411", architectures=["MistralForCausalLM"],
         attention_class="standard",
         hidden_size=12288, num_attention_heads=96, num_hidden_layers=88,
         num_key_value_heads=8, head_dim=128),
    dict(id="mistralai/Ministral-8B-Instruct-2410", architectures=["MistralForCausalLM"],
         attention_class="standard",
         hidden_size=4096, num_attention_heads=32, num_hidden_layers=36,
         num_key_value_heads=8, head_dim=128, sliding_window=32768,
    ...
    dict(id="google/gemma-4-e2b-it", architectures=["Gemma4ForConditionalGeneration"],
         attention_class="mixed_full_sliding",
         hidden_size=1536, num_attention_heads=8, num_hidden_layers=35,
         num_key_value_heads=1, head_dim=256,
         global_head_dim=512, sliding_window=512, num_kv_shared_layers=20,
         full_attention_layers=7, sliding_attention_layers=28),
    dict(id="google/gemma-4-e4b-it", architectures=["Gemma4ForConditionalGeneration"],
         attention_class="mixed_full_sliding",
         hidden_size=2560, num_attention_heads=8, num_hidden_layers=42,
         num_key_value_heads=2, head_dim=256,
         global_head_dim=512, sliding_window=512, num_kv_shared_layers=18,
         full_attention_layers=7, sliding_attention_layers=35),
    dict(id="google/gemma-4-26b-a4b-it", architectures=["Gemma4ForConditionalGeneration"],
         attention_class="mixed_full_sliding",
         hidden_size=2816, num_attention_heads=16, num_hidden_layers=30,
         num_key_value_heads=8, head_dim=256,
         global_head_dim=512, num_global_key_value_heads=2,
         sliding_window=1024, num_kv_shared_layers=0,
         full_attention_layers=5, sliding_attention_layers=25),

    # --- Step 3.5 / 3.7 Flash (mixed full/sliding; grouped head-gated) ---
    dict(id="stepfun-ai/Step-3.5-Flash", architectures=["Step3p5ForCausalLM"],
         attention_class="mixed_full_sliding",
         hidden_size=4096, num_attention_heads=64, num_hidden_layers=45,
         num_key_value_heads=8, head_dim=128, sliding_window=512,
         full_attention_layers=12, sliding_attention_layers=36,
    ...
    dict(id="stepfun-ai/Step-3.7-Flash", architectures=["Step3p7ForConditionalGeneration"],
         attention_class="mixed_full_sliding",
         hidden_size=4096, num_attention_heads=64, num_hidden_layers=45,
         num_key_value_heads=8, head_dim=128, sliding_window=512,
         full_attention_layers=12, sliding_attention_layers=36,
    ...
    dict(id="MiniMaxAI/MiniMax-M3", architectures=["MiniMaxM3SparseForConditionalGeneration"],
         attention_class="minimax_msa",
         hidden_size=6144, num_attention_heads=64, num_hidden_layers=60,
         num_key_value_heads=4, head_dim=128,
...
_META_KEYS = ("id", "architectures", "attention_class", "deployment_measured", "fields", "note")
...
def get_preset(name):
    ...
    preset_id = (
        name if name in PRESETS
        else ALIASES.get(name.lower().strip().lstrip("/"))
    )
...
def key_params_str(entry):
    ...
    elif "kv_lora_rank" not in f and "hidden_size" in f and "num_attention_heads" in f and f["num_attention_heads"]:
