...
- `max_cache_size` *(optional)*:  
  ...
  If not provided, it defaults to **500 GB**.

### Example:

```python
# Allocate up to 500GB DRAM for KV cache
kv_connector_extra_config={"ucm_connector_name": "UcmDram", "ucm_connector_config":{"max_cache_size": 536870912000}}
```
