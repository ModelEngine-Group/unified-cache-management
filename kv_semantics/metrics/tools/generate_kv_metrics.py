...
DEFAULT_HEADER = ROOT / "kv_semantics/metrics/include/kv_metrics/default_metric_descriptors.h"
...
def main() -> int:
    ...
    parser.add_argument("--check", action="store_true", help="check the standalone fallback header")
    args = parser.parse_args()
    content = render_default_header(load_definitions())
    stale = not DEFAULT_HEADER.exists() or DEFAULT_HEADER.read_text(encoding="utf-8") != content
    if args.check:
        if stale:
