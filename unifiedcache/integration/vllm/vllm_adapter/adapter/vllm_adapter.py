from unifiedcache.integration.vllm.vllm_adapter.adapter.utils import patch_dataclass_fields
import importlib
...
from unifiedcache.integration.vllm.vllm_adapter.v1.worker.gpu_model_runner import execute_model, maybe_wait_for_kv_save, _update_states, _prepare_inputs
...
from unifiedcache.integration.vllm.vllm_adapter.distributed.kv_transfer.kv_connector.utils import KVOutputAggregator
utils_mod.KVOutputAggregator = KVOutputAggregator

from vllm.v1.executor import multiproc_executor
from unifiedcache.integration.vllm.vllm_adapter.v1.executor.multiproc_executor import MultiprocExecutor
...
from unifiedcache.integration.vllm.vllm_adapter.v1.worker.gpu_worker import Worker, init_worker_distributed_environment
...
from unifiedcache.integration.vllm.vllm_adapter.attention.layer import unified_attention, unified_attention_with_output
...
from unifiedcache.integration.vllm.vllm_adapter.v1.core.kv_cache_manager import KVCacheManager
kv_cache_manager.KVCacheManager.allocate_slots = KVCacheManager.allocate_slots

from vllm.v1.worker.block_table import BlockTable, MultiGroupBlockTable
from unifiedcache.integration.vllm.vllm_adapter.v1.worker.block_table import reset_row, reset_row_multi
